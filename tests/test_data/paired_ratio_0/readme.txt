pharynx_register MATLAB Python Package
...
2. Installing the pharynx_register Package

A. Change to the directory that contains the file setup.py and the subdirectory 
pharynx_register. If you do not have write permissions, copy all its contents to a 
...
3. Using the pharynx_register Package
...
The pharynx_register package is on your Python path. To import it into a Python script or 
session, execute:

    import pharynx_register
