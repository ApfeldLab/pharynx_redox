pharynx_redox_matlab MATLAB Python Package
...
2. Installing the pharynx_redox_matlab Package

A. Change to the directory that contains the file setup.py and the subdirectory 
pharynx_redox_matlab. If you do not have write permissions, copy all its contents to a 
...
3. Using the pharynx_redox_matlab Package
...
The pharynx_redox_matlab package is on your Python path. To import it into a Python 
script or session, execute:

    import pharynx_redox_matlab
