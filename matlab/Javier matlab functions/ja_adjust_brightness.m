function [ img2 ] = ja_adjust_brightness(img,refimg,cutoff,cm, cmin, cmax)
...
%   cutoff    intensity cutoff.  set the minimal intensity were brighness is 100%
%   cm        colormap
...
tmp = refimg;
tmp = (tmp>cutoff).*cutoff+(tmp<cutoff).*tmp; %ceiling
tmp = tmp./cutoff; % rescale
