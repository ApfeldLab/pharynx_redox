...
%% Plots
fig_directory = "/Users/sean/code/wormAnalysis/matlab/sean/analysis/01-31-19 frank/figures";
...
figure;
hold on;
plot(mean(i_470(:,hd233_idx), 2));
plot(mean(i_470(:,say75_idx), 2));
