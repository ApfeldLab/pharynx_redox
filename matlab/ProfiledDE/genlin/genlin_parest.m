...
[full_time,full_path] = ode45(odefn,tspan,y0,odeopts,[pars; 1; 0]);

plot(full_time,full_path)
...
save 'genlin_parest.mat' parest covest errs errs_true
