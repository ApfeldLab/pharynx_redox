function [newpars,DEfd] = Profile_GausNewt_rep(pars,lsopts,parind,DEfd,...
            fn,lambda,Ycell,Tcell,wts,alg,lsopts2,fn_extras,...
            pen,dpen,pen_extras);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
%
% fn.fn    -   a struct containing functions of the right hand side and its
...
[res0,Dres,DEfd] = ProfileErr_rep(pars,parind,DEfd,fn,lambda,Ycell,...
    Tcell,wts,alg,lsopts2,fn_extras,pen,dpen,pen_extras);
...
%    end
    ...
    ntry = 0;
    while F1 >= F0 & norm(Dpars) > lsopts.TolFun
        pars1 = pars0 - Dpars;
        [tres1,tDres,tDEfd,tdcdp] = ProfileErr_rep(pars1,parind,DEfd,fn,...
            lambda,Ycell,Tcell,wts,alg,lsopts2,fn_extras,...
            pen,dpen,pen_extras,dcdp,pars0);
        F1 = sum(tres1.^2);
        Dpars = Dpars/2;
        ntry = ntry + 1;
    end
