...
start_pm8=2;        %start of cell boundary //NEW
end_pm8 =6;         %end of cell boundary

start_pm7=8;        %start of cell boundary
end_pm7 =12;         %end of cell boundary // NEW end pm7=9

start_pm5=29;        %start of cell boundary
end_pm5 =48;         %end of cell boundary

start_pm4=57;        %start of cell boundary
...
end_medax =98;         %end of cell boundary  //NEW before end_medax =95;   
