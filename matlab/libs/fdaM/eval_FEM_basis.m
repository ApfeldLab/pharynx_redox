    ...
    if ~isnan(indi)
        ...
        if order == 2
            if    sum(nderivs) == 0
                ...
                evalmat(i,nodeindex(indi,6)) = 4*baryc1.* baryc2;
                evalmat(i,nodeindex(indi,4)) = 4*baryc2.* baryc3;
                evalmat(i,nodeindex(indi,5)) = 4*baryc3.* baryc1;
            elseif nderivs(1) == 1 && nderivs(2) == 0
                ...
                evalmat(i,nodeindex(indi,6)) = 4*baryc2.*M1(indi,2) + ...
                                               4*baryc1.*M2(indi,2);
                evalmat(i,nodeindex(indi,4)) = 4*baryc3.*M2(indi,2) + ...
                                               4*baryc2.*M3(indi,2);
                evalmat(i,nodeindex(indi,5)) = 4*baryc1.*M3(indi,2) + ...
                                               4*baryc3.*M1(indi,2);
            elseif nderivs(1) == 0 && nderivs(2) == 1
                ...
                evalmat(i,nodeindex(indi,6)) = 4*baryc2.*M1(indi,3) + ...
                                               4*baryc1.*M2(indi,3);
                evalmat(i,nodeindex(indi,4)) = 4*baryc3.*M2(indi,3) + ...
                                               4*baryc2.*M3(indi,3);
                evalmat(i,nodeindex(indi,5)) = 4*baryc1.*M3(indi,3) + ...
                                               4*baryc3.*M1(indi,3);
            elseif nderivs(1) == 1 && nderivs(2) == 1
                ...
                evalmat(i,nodeindex(indi,6)) = 4*M2(indi,2)*M1(indi,3)+ ...
                                               4*M2(indi,3)*M1(indi,2);
                evalmat(i,nodeindex(indi,4)) = 4*M3(indi,2)*M2(indi,3)+ ...
                                               4*M3(indi,3)*M2(indi,2);
                evalmat(i,nodeindex(indi,5)) = 4*M1(indi,2)*M3(indi,3)+ ...
            ...
            elseif nderivs(1) == 2 && nderivs(2) == 0
                ...
                evalmat(i,nodeindex(indi,6)) = 8*M2(indi,2)*M1(indi,2);
                evalmat(i,nodeindex(indi,4)) = 8*M3(indi,2)*M2(indi,2);
                evalmat(i,nodeindex(indi,5)) = 8*M1(indi,2)*M3(indi,2);
            elseif nderivs(1) == 0 && nderivs(2) == 2
                ...
                evalmat(i,nodeindex(indi,6)) = 8*M2(indi,3)*M1(indi,3);
                evalmat(i,nodeindex(indi,4)) = 8*M3(indi,3)*M2(indi,3);
                evalmat(i,nodeindex(indi,5)) = 8*M1(indi,3)*M3(indi,3);
            else
